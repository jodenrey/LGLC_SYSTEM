...
namespace LGLC_SYSTEM
{
    ...
    {
        double n, thou, hun, tens, ones, zero, elevens;
        int TogMove;
        int MValX;
        int MValY;
        ...
        private void lblPesos_Click(object sender, EventArgs e)
        {
        ...
        private void lblNumberWord_Click(object sender, EventArgs e)
        {
        ...
        void NumberToWords()
        {
            double n = Convert.ToDouble(lblPesos.Text);
