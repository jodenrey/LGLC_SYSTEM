...
namespace LGLC_SYSTEM
{
    public partial class frmEnrollment : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (txtBillID.Text == "")
            {
                MessageBox.Show("Please search student to be enroll", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
                try
                {
                    ...
                    MessageBox.Show("Mr/Ms " + lblName.Text + " is successfully enrolled", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
