...
namespace LGLC_SYSTEM
{
    public partial class fillUpForm : Form
    {
         ...
         void generateCode()
        {
         ...
         private void btnSave_Click(object sender, EventArgs e)
         {
            if (txtContact.Text.Length == 11)
            {
                ...
                if (txtIDno.Text == "" || txtName.Text == "" || txtLastName.Text == "" || txtHomeAddress.Text == "" || txtAge.Text == "" || cmbGender.Text == "" || txtGuard.Text == "" || txtAddress.Text == "" || txtContact.Text == "" || cmbLvlType.Text == "")
                {
                ...
                try
                {
                    ...
                    if (radioButton1.Checked == true)
                    {
                        ...
                        string sql = "insert into tbl_Student(ID,Lname,Name,MI,completeName,Suffix,DateBirth,Age,HAddress,Gender,Guardian,PAddress,Contact,Dates,studentStand,levelType) values('" + txtIDno.Text + "','" + txtLastName.Text + "','" + txtName.Text + "','" + txtMI.Text + "','" + txtName.Text + " " + txtMI.Text + " " + txtLastName.Text + " " + txtSuffix.Text +
                                    "','" + txtSuffix.Text + "','" + dateTimePicker1.Text + "','" + txtAge.Text + "','" + txtHomeAddress.Text + "','" + cmbGender.Text + "','" + txtGuard.Text + "','" + txtAddress.Text + "','" + txtContact.Text + "','" + DateTime.Now.ToString() + "','" + radioButton2.Text + "','" + cmbLvlType.Text + "')";
                        cm = new SqlCommand(sql, cn);
                        cm.ExecuteNonQuery();
                        ...
                        auditrail(uID, "Mr/Ms [" + txtName.Text + " " + txtMI.Text + " " + txtLastName.Text + " " + txtSuffix.Text + "] was successfully added to the student list");
         ...
         private void studentList_SelectedIndexChanged(object sender, EventArgs e)
         {
             ...
             txtLastName.Text = studentList.FocusedItem.SubItems[1].Text;
             txtName.Text = studentList.FocusedItem.SubItems[2].Text;
             txtMI.Text = studentList.FocusedItem.SubItems[3].Text;    
             txtSuffix.Text = studentList.FocusedItem.SubItems[4].Text;          
             txtAge.Text = studentList.FocusedItem.SubItems[5].Text;
         ...
         private void txtSearch_TextChanged(object sender, EventArgs e)
         {
             try
             {
                 ...
                 studentList.Columns.Add("Suffix", 200);          
                 ...
                 string sql = "Select * from tbl_Student where Lname like '" + txtSearch.Text + "%' order by Lname";
                 cm = new SqlCommand(sql, cn);
                 dr = cm.ExecuteReader();
                 while (dr.Read())
                 {
          ...
          if (txtIDno.Text == "" || txtName.Text == "" || txtLastName.Text == "" || txtHomeAddress.Text == "" || txtAge.Text == "" || cmbGender.Text == "" || txtGuard.Text == "" || txtAddress.Text == "" || txtContact.Text == "" || cmbLvlType.Text == "")
            ...
            if (txtContact.Text.Length == 11)
            {
                try
                {
                    ...
                    string sql = "Update tbl_Student set Lname = '" + txtLastName.Text + "',Name = '" + txtName.Text + "',MI = '" + txtMI.Text +  "',completeName = '" + txtName.Text + " " + txtMI.Text + " " + txtLastName.Text + " " + txtSuffix.Text + "',Suffix = '" + txtSuffix.Text + "',DateBirth = '" + dateTimePicker1.Text + "',Age = '" + txtAge.Text
                                                                       + "',HAddress = '" + txtHomeAddress.Text + "',Gender = '" + cmbGender.Text + "',Guardian = '" + txtGuard.Text + "',PAddress = '" + txtAddress.Text + "',Contact = '" + txtContact.Text + "',levelType = '" + cmbLvlType.Text + "' where ID like '" + txtIDno.Text + "'";
        ...
        private void txtGuard_KeyPress(object sender, KeyPressEventArgs e)
        {
