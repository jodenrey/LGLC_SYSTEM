    ...
    public partial class frmTime : Form
    {
        ...
        private void btnAddRoom_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("The schedule is already added", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    clear();
                ...
                cm = new SqlCommand(sql, cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("The " + txtFrom.Text + " to " + txtTo.Text + " is successfully save", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            cm = new SqlCommand(sql,cn);
            cm.ExecuteNonQuery();
            MessageBox.Show("The " + txtTime.Text +" is successfully deleted", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (txtFrom.Text == "" || txtTo.Text == "" || cmbSession.Text == "")
            {
                MessageBox.Show("Please select the time you want to update", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            else
            {
                ...
                cm = new SqlCommand(sql,cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("The " + txtFrom.Text + " to " + txtTo.Text + " is successfully updated", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
