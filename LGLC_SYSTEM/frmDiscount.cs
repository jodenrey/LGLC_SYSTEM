...
namespace LGLC_SYSTEM
{
    public partial class frmDiscount : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Discount is successfully update", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
            txtDis.Text = "";
            listDis.Items.Clear();
            getDis();
        }
        ...
        private void txtDis_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                txtPercent.Text = Convert.ToString(Convert.ToDouble(txtDis.Text) * 0.01 + 0.7);
