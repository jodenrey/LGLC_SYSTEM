...
namespace LGLC_SYSTEM
{
    public partial class frmGradeLvlMaintenance : Form
    {
        ...
        private void btnAddLvl_Click(object sender, EventArgs e)
        {
            if (txtGradeLvl.Text == "")
            {
                MessageBox.Show("Please fill the empty field", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            ...
            else
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("This " + dr[1].ToString() + " grade level is already added", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dr.Close();
                    return;
                }
                dr.Close();
                ...
                cm = new SqlCommand(sql, cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Grade level is successfully save", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cm = new SqlCommand(sql,cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Grade level is successfully updated", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                //cm = new SqlCommand(sql, cn);
                //cm.ExecuteNonQuery();
                //MessageBox.Show("Year is successfully deleted", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
                //listGradeLvl.Items.Clear();
                //ListGradeLvl();
                //cm.Dispose();
                //txtGradeLvl.Text = "";
