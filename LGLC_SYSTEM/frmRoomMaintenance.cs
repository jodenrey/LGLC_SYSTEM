    ...
    public partial class frmRoomMaintenance : Form
    {
        ...
        private void btnAddRoom_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("This " + dr[1].ToString() + " is already added", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dr.Close();
                    return;
                }
                dr.Close();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show("Room is successfully delete", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
