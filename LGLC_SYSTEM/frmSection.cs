    ...
    public partial class frmSection : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("Mr/Ms " + cmbAdviser.Text + " is already assigned to section " + txtSection.Text + "", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    clear();
                    dr.Close();
                    return;
                }
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("This section is already added", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    clear();
                    dr.Close();
                    return;
                }
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("Mr/Ms " + cmbAdviser.Text + " is already assigned to " + cmbTime.Text + "", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    clear();
                    dr.Close();
                    return;
                }
                ...
                cm = new SqlCommand(sql, cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Section is successfully save", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cm = new SqlCommand(sql, cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Section is successfully updated", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cm = new SqlCommand(sql, cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Section is successfully deleted", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
