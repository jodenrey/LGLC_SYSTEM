...
namespace LGLC_SYSTEM
{
    public partial class frmSubject : Form
    {
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            cm = new SqlCommand(sql, cn);
            cm.ExecuteNonQuery();
            MessageBox.Show("Subject is successfully deleted to " + cmbGradeLvl.Text + "", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
            cm.Dispose();
            txtSubject.Text = "";
            listSubject.Items.Clear();
            viewList();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("The "+ txtSubject.Text + " is already added to " + cmbGradeLvl.Text + "", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtSubject.Text = "";
                    dr.Close();
                    return;
                }
                ...
                cm = new SqlCommand(sql,cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Subject is successfully assigned to " + cmbGradeLvl.Text + "", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
                cm.Dispose();
                txtSubject.Text = "";
                btnDel.Enabled = false;
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cm = new SqlCommand(sql,cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Subject is successfully updated to " + cmbGradeLvl.Text + "", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
                cm.Dispose();
                txtSubject.Text = "";
                listSubject.Items.Clear();
                viewList();
