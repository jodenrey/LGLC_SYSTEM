...
namespace LGLC_SYSTEM
{
    public partial class frmDownpayment : Form
    {
        ...
        private void btnAddRoom_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please input the amount", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            cm = new SqlCommand(sql,cn);
            cm.ExecuteNonQuery();
            MessageBox.Show("Downpayment is successfully save", "Little Garden Learning Center", MessageBoxButtons.OK,MessageBoxIcon.Information);
            txtDown.Text = "";
