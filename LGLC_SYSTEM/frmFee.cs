    ...
    public partial class frmFee : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("The " + txtTitle.Text + " are already added to " + cmbFeeType.Text + " type", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                cm = new SqlCommand(sql,cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Tuition fee is successfully save", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cm = new SqlCommand(sql,cn);
                cm.ExecuteReader();
                MessageBox.Show("Tuition fee is successfully updated", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            cm = new SqlCommand(sql,cn);
            cm.ExecuteNonQuery();
            MessageBox.Show("Tuition fee is successfully deleted", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
