    ...
    public partial class frmYearMaintenance : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("This year " + dr[1].ToString() + " to " + dr[2].ToString() + " is already added", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dr.Close();
                    return;
                }
                dr.Close();
                ...
                MessageBox.Show("Year is successfull save", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    MessageBox.Show("Please select year to be deleted", " Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //    return;
            //}
        ...
        private void btnActivate_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Year is Active", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listYear.Items.Clear();
            year();
            cm.Dispose();
            btnErase_Click(sender, e);
