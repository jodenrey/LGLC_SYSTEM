...
namespace LGLC_SYSTEM
{
    public partial class frmLogin : Form
    {
        ...
        public string constring = @"Data Source=DESKTOP-QCFAA4K;Initial Catalog=LGLC_DB;Integrated Security=True";
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("This account is currently online, you forgot to logout. Please approach administrator for help. Thank you", "LGLC_SYSTEM", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dr.Close();
                    return;
                }
                dr.Close();
                ...
                if (dr.HasRows)
                {
                    ...
                    MessageBox.Show("\tWelcome " + dr.GetValue(3).ToString() + " \n Time&Date Login : " + DateTime.Now.ToString() + "", "LGLC_SYSTEM", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    dr.Close();
                    getuID();
                    insertToLogTrail();
                    updateStatus();
        ...
        {
            DialogResult exit = MessageBox.Show("Are you sure you want to exit?", "LGLC_SYSTEM", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
