    ...
    public partial class frmBilling : Form
    {
        ...
        private void txtID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr.HasRows /*&& bal != "0"*/)
                {
                    MessageBox.Show("You have a previous balance", "Little Garder Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Insuficient amount to pay downpayment", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            else
            {
               ...
               // catch (Exception ee)
              //  {
               //     MessageBox.Show(ee.Message, "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Warning);
               // }
            }
