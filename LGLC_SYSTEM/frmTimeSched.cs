...
namespace LGLC_SYSTEM
{
    public partial class frmTimeSched : Form
    {
        ...
        private void btnTsched_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please input the empty fields!", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("This schedule is already assigned by " + dr[5].ToString() + "", "Little Garden Learning Centery", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dr.Close();
                    return;
                }
                dr.Close();
                ...
                cm = new SqlCommand(sql, cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Successfuly Save!", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if (cmbSession.Text == "" || cboTime.Text == "" || txtCapacity.Text == "" || cmbRoom.Text == "" || cmbGradeLevel.Text == "")
            {
                MessageBox.Show("Please select schedule", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                ...
                cm = new SqlCommand(sql, cn);
                cm.ExecuteNonQuery();
                MessageBox.Show("Schedule is successfuly update", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Information);
                schedList.Items.Clear();
                schedule();
                cm.Dispose();
            }
