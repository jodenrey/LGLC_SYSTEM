...
namespace LGLC_SYSTEM
{
    public partial class frmListEnrolless : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select school year, grade level and section", "Little Garden Learning Center", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
        ...
        private void enrolleesList_SelectedIndexChanged(object sender, EventArgs e)
        {
